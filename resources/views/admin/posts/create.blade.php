                ...
                <div class="box-body">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control" value="{{old('title')}}" id="exampleInputEmail1" placeholder="">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::select('tags[]',
                             $tags,
                              null,
                              ['class' => 'form-control select2', 'multiple'=>'multiple', 'data-placeholder'=>
                              'Выберите теги'])
                               !!}
